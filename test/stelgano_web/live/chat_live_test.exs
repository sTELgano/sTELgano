...
defmodule StelganoWeb.ChatLiveTest do
  ...
  # ---------------------------------------------------------------------------
  # Entry screen — without phone param (manual entry)
  # ---------------------------------------------------------------------------
  ...
  describe "GET /chat (no phone)" do
    ...
    test "phone field is not readonly when no phone param", %{conn: conn} do
      {:ok, _view, html} = live(conn, ~p"/chat")
  ...
  # ---------------------------------------------------------------------------
  # Entry screen — with phone param (locked form)
  # ---------------------------------------------------------------------------
